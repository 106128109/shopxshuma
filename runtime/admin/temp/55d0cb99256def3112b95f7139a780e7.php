    ...
    <table class="am-table am-table-striped am-table-hover am-table-bordered am-text-nowrap form-table-data-list">
        ...
        <tbody>
            <?php if(!empty($data_list) and !empty($form_table['base']['key_field'])): ?>
                <!-- 处理数据数量小于默认数量 -->
                <?php $__FOR_START_1385659382__=0;$__FOR_END_1385659382__=count($data_list);for($i=$__FOR_START_1385659382__;$i < $__FOR_END_1385659382__;$i+=1){ ?>
                    <!-- 1. tr 主键id名称 -->
                    <!-- 2. 是否黄色选中class -->
                    <tr
        ...
        <div class="am-popup-inner">
            ...
            <div class="am-popup-bd am-padding-0">
                <form class="am-form am-padding-sm goods-add-container">
                    <!-- 搜索 -->
                    <div class="forth-selection-container" data-search-url="<?php echo MyUrl('admin/warehousegoods/goodssearch'); ?>">
                        <select class="am-radius chosen-select forth-selection-form-warehouse" data-placeholder="仓库..." data-validation-message="请选择仓库">
                            ...
                            <?php if(!empty($warehouse_list)): foreach($warehouse_list as $v): ?>
                    ...
                    <!-- 商品列表 -->
                    <div class="am-scrollable-vertical am-margin-top-sm am-padding-bottom-xs goods-list-container" data-loading-msg="搜索中..." data-add-url="<?php echo MyUrl('admin/warehousegoods/goodsadd'); ?>" data-del-url="<?php echo MyUrl('admin/warehousegoods/goodsdel'); ?>">
