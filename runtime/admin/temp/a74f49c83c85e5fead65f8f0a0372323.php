                    ...
                    <div class="business-form-group am-padding-vertical-0 platform-list-value-container">
                        ...
                        <?php foreach($common_platform_type as $v): ?>
                            <div class="am-input-group am-input-group-sm">
                                ...
                                <select name="common_default_payment[<?php echo htmlentities($v['value']); ?>]" class="am-radius chosen-select" data-placeholder="可选择..." data-validation-message="请选择<?php echo htmlentities($v['name']); ?>默认支付方式">
