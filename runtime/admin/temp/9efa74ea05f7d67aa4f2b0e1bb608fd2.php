...
<div class="content-right">
    ...
    <li <?php if($nav_type == 'base'): ?>class="am-active"<?php endif; ?> data-type="base">
        <a href="<?php echo MyUrl('admin/appconfig/index', ['nav_type'=>'base']); ?>">基础配置</a>
    </li>
    <li <?php if($nav_type == 'app'): ?>class="am-active"<?php endif; ?> data-type="app">
        <a href="<?php echo MyUrl('admin/appconfig/index', ['nav_type'=>'app']); ?>">APP/小程序</a>
    </li>
</ul>
    <!-- table nav end -->
	...
	<div class="content">
		<!-- form start -->
		<form class="am-form form-validation" action="<?php echo MyUrl('admin/appconfig/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/appconfig/index'); ?>">
