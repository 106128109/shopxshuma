...
<?php endif; ?>
        ...
        <form class="am-form form-validation" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>$nav_type, 'view_type'=>$view_type]); ?>" enctype="multipart/form-data">
            ...
            <div class="am-panel am-panel-default am-margin-top-sm">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_index_friendship_link_status']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_index_friendship_link_status']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['home_index_friendship_link_status']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_index_friendship_link_status']['error_tips']); ?>" required>
                            <?php foreach($common_close_open_list as $v): ?>
                                <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_index_friendship_link_status']['value']) and $data['home_index_friendship_link_status']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>

                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_header_top_is_home']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_header_top_is_home']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['home_header_top_is_home']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_header_top_is_home']['error_tips']); ?>" required>
                            <?php foreach($common_close_open_list as $v): ?>
                                <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_header_top_is_home']['value']) and $data['home_header_top_is_home']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="am-panel am-panel-default am-margin-top-sm">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_navigation_main_quick_status']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_navigation_main_quick_status']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['home_navigation_main_quick_status']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_navigation_main_quick_status']['error_tips']); ?>" required>
                            <?php foreach($common_close_open_list as $v): ?>
                                <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_navigation_main_quick_status']['value']) and $data['home_navigation_main_quick_status']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_navigation_main_quick_name']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_navigation_main_quick_name']['describe']); ?></span></label>
                        <input type="text" maxlength="4" name="<?php echo htmlentities($data['home_navigation_main_quick_name']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_navigation_main_quick_name']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_navigation_main_quick_name']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_navigation_main_quick_name']['value']); ?>"<?php endif; ?> />
                    </div>
                </div>
            </div>
            ...
            <div class="am-panel am-panel-default am-margin-top-sm">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_user_address_map_status']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_user_address_map_status']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['home_user_address_map_status']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_user_address_map_status']['error_tips']); ?>" required>
                            <?php foreach($common_close_open_list as $v): ?>
                                <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_user_address_map_status']['value']) and $data['home_user_address_map_status']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_user_address_idcard_status']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_user_address_idcard_status']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['home_user_address_idcard_status']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_user_address_idcard_status']['error_tips']); ?>" required>
                            <?php foreach($common_close_open_list as $v): ?>
                                <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_user_address_idcard_status']['value']) and $data['home_user_address_idcard_status']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>

                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_extraction_address_position']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_extraction_address_position']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['home_extraction_address_position']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_extraction_address_position']['error_tips']); ?>" required>
                            <?php foreach($common_close_open_list as $v): ?>
                                <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_extraction_address_position']['value']) and $data['home_extraction_address_position']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
