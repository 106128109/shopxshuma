...
<?php endswitch; ?>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'register']); ?>" enctype="multipart/form-data">
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_user_reg_type']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_user_reg_type']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_user_reg_type']['only_tag']); ?>" multiple="multiple" class="am-radius chosen-select" data-placeholder="<?php echo htmlentities($data['home_user_reg_type']['name']); ?>">
                    <?php foreach($common_user_reg_type_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_user_reg_type']['value']) and in_array($v['value'], $data['home_user_reg_type']['value'])): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_is_enable_userregister_agreement']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_is_enable_userregister_agreement']['describe']); ?></span></label>
