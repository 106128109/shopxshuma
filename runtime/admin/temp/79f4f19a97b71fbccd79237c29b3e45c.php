<?php /*a:4:{s:70:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/seo/index.html";i:1665913498;s:74:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/public/header.html";i:1665913498;s:80:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/public/page_loading.html";i:1665913498;s:74:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/public/footer.html";i:1665913498;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	<div class="content">
		<div class="am-alert am-alert-warning am-radius am-margin-bottom-0" data-am-alert>
		    ...
		    <p class="am-text-xs">根据服务器环境[Nginx、Apache、IIS]不同配置相应的伪静态规则 <?php if(!empty($site_store_links) and !empty($site_store_links['htaccess_set_course'])): ?><a href="<?php echo htmlentities($site_store_links['htaccess_set_course']); ?>" class="am-margin-left-sm" target="_blank">查看配置教程 <i class="am-icon-external-link"></i></a><?php endif; ?></p>
		</div>

		<!-- form start -->
		<form class="am-form form-validation" action="<?php echo MyUrl('admin/seo/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/seo/index'); ?>">
