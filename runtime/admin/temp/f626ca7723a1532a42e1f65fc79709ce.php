...
<div class="content-right">
    ...
    <?php if(!IsMobile()): ?>
        <a href="<?php echo htmlentities($excel_url); ?>" class="am-btn am-btn-success am-btn-xs am-icon-file-excel-o am-radius" target="_blank"> 导出Excel</a>
    <?php endif; ?>
    <!-- 父级内容 -->
    ...
    <table class="am-table am-table-striped am-table-hover am-table-bordered am-text-nowrap form-table-data-list">
        ...
        <tbody>
            <?php if(!empty($data_list) and !empty($form_table['base']['key_field'])): ?>
                <!-- 处理数据数量小于默认数量 -->
                <?php $__FOR_START_192543185__=0;$__FOR_END_192543185__=count($data_list);for($i=$__FOR_START_192543185__;$i < $__FOR_END_192543185__;$i+=1){ ?>
                    <!-- 1. tr 主键id名称 -->
                    <!-- 2. 是否黄色选中class -->
                    <tr
