...
<?php endswitch; ?>
	...
	<div class="content">
		<!-- form start -->
		<form class="am-form form-validation" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index'); ?>" enctype="multipart/form-data">
			<!-- 基础配置 -->
            <div class="am-panel am-panel-default">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
					...
					<div class="am-form-group">
						<label class="block"><?php echo htmlentities($data['home_site_logo_square']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_logo_square']['describe']); ?></span></label>
						...
						<div class="plug-file-upload-submit" data-view-tag="ul.home_site_logo_square-images-view">+选择logo</div>
					</div>
            ...
            <div class="am-panel am-panel-default">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title">站点域名地址</h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-alert am-alert-warning am-margin-top-xs" data-am-alert>
                        <button type="button" class="am-close">&times;</button>
                        <p>2. 站点域名未设置则使用当前站点域名域名地址[ <a href="<?php echo htmlentities($my_domain); ?>" target="_blank"><?php echo htmlentities($my_domain); ?></a> ]</p>
                        <p>2. 附件和静态地址未设置则使用当前站点静态域名地址[ <a href="<?php echo htmlentities($my_public_url); ?>" target="_blank"><?php echo htmlentities($my_public_url); ?></a> ]</p>
                        <p>3. 如服务器端不是以public设为根目录的、则这里配置【附件cdn域名、css/js静态文件cdn域名】需要后面再加public、如：<?php echo htmlentities($my_public_url); ?>public/</p>
                        <div class="am-text-danger am-margin-top-xs">
                        	<p>在命令行模式下运行项目，该区域地址必须配置、否则项目中一些地址会缺失域名信息。</p>
                        	<p>请勿乱配置、错误地址会导致网站无法访问（地址配置以http开头）、如果自己站的配置了https则以https开头</p>
                        </div>
                    </div>
                    <div class="am-form-group">
