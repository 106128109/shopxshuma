...
<?php endif; ?>
        ...
        <form class="am-form form-validation" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>$nav_type, 'view_type'=>$view_type]); ?>" enctype="multipart/form-data">
            <div class="am-form-group">
                <label><?php echo htmlentities($data['is_close_goods_discount_overlap']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['is_close_goods_discount_overlap']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['is_close_goods_discount_overlap']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['is_close_goods_discount_overlap']['error_tips']); ?>" required>
                    <?php foreach($common_is_text_list as $v): ?>
                        <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['is_close_goods_discount_overlap']['value']) and $data['is_close_goods_discount_overlap']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
