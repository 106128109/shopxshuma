...
<?php endswitch; ?>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'login']); ?>" enctype="multipart/form-data">
            <!-- 基础配置 -->
            <div class="am-panel am-panel-default">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_user_login_type']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_user_login_type']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['home_user_login_type']['only_tag']); ?>" multiple="multiple" class="am-radius chosen-select" data-placeholder="<?php echo htmlentities($data['home_user_login_type']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_user_login_type']['error_tips']); ?>">
                            <?php foreach($common_login_type_list as $v): ?>
                                <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_user_login_type']['value']) and in_array($v['value'], $data['home_user_login_type']['value'])): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>

                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_user_login_img_verify_state']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_user_login_img_verify_state']['describe']); ?></span></label>
            ...
            <div class="am-panel am-panel-default">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="block"><?php echo htmlentities($data['home_site_user_login_ad1_images']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_login_ad1_images']['describe']); ?></span></label>
                        ...
                        <div class="plug-file-upload-submit" data-view-tag="ul.home_site_user_login_ad1_images-images-view">+选择图片</div>
                    </div>

                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_site_user_login_ad1_url']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_login_ad1_url']['describe']); ?></span></label>
            ...
            <div class="am-panel am-panel-default">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="block"><?php echo htmlentities($data['home_site_user_login_ad2_images']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_login_ad2_images']['describe']); ?></span></label>
                        ...
                        <div class="plug-file-upload-submit" data-view-tag="ul.home_site_user_login_ad2_images-images-view">+选择图片</div>
                    </div>

                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_site_user_login_ad2_url']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_login_ad2_url']['describe']); ?></span></label>
            ...
            <div class="am-panel am-panel-default">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="block"><?php echo htmlentities($data['home_site_user_login_ad3_images']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_login_ad3_images']['describe']); ?></span></label>
                        ...
                        <div class="plug-file-upload-submit" data-view-tag="ul.home_site_user_login_ad3_images-images-view">+选择图片</div>
                    </div>

                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_site_user_login_ad3_url']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_login_ad3_url']['describe']); ?></span></label>
