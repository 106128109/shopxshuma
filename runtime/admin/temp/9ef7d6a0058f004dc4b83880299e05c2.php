        ...
        <div class="am-popup am-radius" id="data-save-win">
			<div class="am-popup-inner">
				...
				<div class="am-popup-bd">
					<!-- form start -->
					<form class="am-form form-validation admin-save" action="<?php echo MyUrl('admin/region/save'); ?>" method="POST" request-type="ajax-fun" request-value="TreeFormSaveBack">
