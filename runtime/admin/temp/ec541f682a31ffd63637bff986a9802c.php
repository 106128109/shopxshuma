<?php /*a:7:{s:72:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/index/index.html";i:1665913498;s:74:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/public/header.html";i:1665913498;s:80:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/public/page_loading.html";i:1665913498;s:71:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/public/nav.html";i:1665913498;s:72:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/public/menu.html";i:1665913498;s:75:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/public/nav_bar.html";i:1665913498;s:74:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/public/footer.html";i:1665913498;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<header class="am-topbar am-topbar-inverse admin-header">
	<div class="am-topbar-brand">
		<a href="<?php echo MyUrl('admin/index/index'); ?>">
			<h2><span class="admin-site-vice-name am-margin-left-xs">后台管理系统</span></h2>
		</a>
	</div>
	...
	<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
		<ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
			<li class="am-dropdown">
				<a href="<?php echo htmlentities($admin_color_url); ?>">
					<i class="am-icon-adjust"></i>
					<span><?php echo htmlentities($admin_color_name); ?></span>
				</a>
			</li>
	...
	<div class="am-offcanvas-bar admin-offcanvas-bar">
		<ul class="am-list admin-sidebar-list common-left-menu">
			...
			<?php foreach($left_menu as $v): if(empty($v['items'])): ?>
					<li>
						<a href="javascript:;" data-type="menu" data-url="<?php echo htmlentities($v['url']); ?>">
					...
					<li class="admin-parent">
						...
						<ul class="am-list am-collapse admin-sidebar-sub" id="power-menu-<?php echo htmlentities($v['id']); ?>">
							<?php foreach($v['items'] as $vs): ?>
								<li>
									<a href="javascript:;" class="menu-items-<?php echo htmlentities($vs['id']); ?>" data-parent-id="<?php echo htmlentities($v['id']); ?>" data-type="menu" data-url="<?php echo htmlentities($vs['url']); ?>">
...
<div class="menu-mini-container-popup am-animation-slide-right">
	...
	<!-- right content  -->
	<iframe id="ifcontent" src="<?php echo htmlentities($to_url); ?>" width="100%" height="100%"></iframe>
	<!-- right content end  -->
</div>
