<?php /*a:5:{s:80:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/warehouse/save_info.html";i:1665913498;s:74:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/public/header.html";i:1665913498;s:80:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/public/page_loading.html";i:1665913498;s:79:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/lib/region_linkage.html";i:1665913498;s:74:"/home/wwwroot/www.tianjinyuxi.cn/app/admin/view/default/public/footer.html";i:1665913498;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation" action="<?php echo MyUrl('admin/warehouse/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/warehouse/index', $params); ?>">
            <legend>
                <span class="am-text-default">仓库<?php if(empty($data['id'])): ?>添加<?php else: ?>编辑<?php endif; ?></span>
                <a href="<?php echo MyUrl('admin/warehouse/index', $params); ?>" class="am-fr am-text-sm am-margin-top-sm am-icon-mail-reply"> 返回</a>
            </legend>

            <div class="am-form-group">
                <label>名称<span class="am-form-group-label-tips-must">必填</span></label>
                <input type="text" name="name" placeholder="名称" minlength="2" maxlength="30" data-validation-message="名称格式 2~30 个字符之间" class="am-radius" <?php if(!empty($data)): ?> value="<?php echo htmlentities($data['name']); ?>"<?php endif; ?> required />
            </div>
            <div class="am-form-group">
            ...
            <div class="am-form-group">
                ...
                <input type="number" name="level" placeholder="权重" minlength="0" maxlength="16" data-validation-message="请输入有效权重数值" class="am-radius" <?php if(!empty($data)): ?> value="<?php echo htmlentities($data['level']); ?>"<?php endif; ?> />
            </div>

            <div class="am-form-group">
                <label>联系人<span class="am-form-group-label-tips-must">必填</span></label>
                <input type="text" name="contacts_name" placeholder="联系人" minlength="2" maxlength="16" data-validation-message="联系人格式 2~16 个字符之间" class="am-radius" <?php if(!empty($data)): ?> value="<?php echo htmlentities($data['contacts_name']); ?>"<?php endif; ?> required />
            </div>
            <div class="am-form-group">
                <label>联系电话<span class="am-form-group-label-tips-must">必填</span></label>
                <input type="text" name="contacts_tel" placeholder="电话" minlength="6" maxlength="30" data-validation-message="电话格式有误" class="am-radius" <?php if(!empty($data)): ?> value="<?php echo htmlentities($data['contacts_tel']); ?>"<?php endif; ?> required />
            </div>
    ...
    <select name="county" class="am-radius chosen-select" data-placeholder="区/县" data-validation-message="请选择区/县" data-value="<?php if(isset($data['county'])): ?><?php echo htmlentities($data['county']); else: ?>0<?php endif; ?>" required>
        <option value="">区/县</option>
            ...
            <div class="am-form-group">
                ...
                <input name="is_enable" value="1" type="checkbox" data-off-text="否" data-on-text="是" data-size="xs" data-on-color="success" data-off-color="default" data-handle-width="49" data-am-switch <?php if(isset($data['is_enable']) and $data['is_enable'] == 1): ?>checked="true"<?php endif; ?> />
            </div>
