...
<div class="content-right">
    ...
    <a href="<?php echo MyUrl('admin/warehouse/saveinfo'); ?>" class="am-btn am-btn-secondary am-radius am-btn-xs am-icon-plus"> 新增</a>
    <!-- 父级内容 -->
    ...
    <table class="am-table am-table-striped am-table-hover am-table-bordered am-text-nowrap form-table-data-list">
        ...
        <tbody>
            <?php if(!empty($data_list) and !empty($form_table['base']['key_field'])): ?>
                <!-- 处理数据数量小于默认数量 -->
                <?php $__FOR_START_1217386158__=0;$__FOR_END_1217386158__=count($data_list);for($i=$__FOR_START_1217386158__;$i < $__FOR_END_1217386158__;$i+=1){ ?>
                    <!-- 1. tr 主键id名称 -->
                    <!-- 2. 是否黄色选中class -->
                    <tr
