...
<div class="am-alert am-margin-horizontal-sm am-margin-bottom-0" data-am-alert>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation" action="<?php echo MyUrl('admin/agreement/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/agreement/index', ['nav_type'=>$nav_type]); ?>">
