    ...
    <div class="am-u-md-10 am-u-md-push-2 article-right">
        <?php if(!empty($category_info)): ?>
            <div class="article-header am-text-center am-padding-0">
                <h1 class="am-article-title"><?php echo htmlentities($category_info['name']); ?></h1>
                    ...
                    <ul class="am-list category-content-list">
                        <?php foreach($data_list as $v): ?>
                            <li class="am-g am-list-item-dated">
                                <a href="<?php echo htmlentities($v['url']); ?>" class="am-list-item-hd" <?php if(!empty($v['title_color'])): ?>style="color:<?php echo htmlentities($v['title_color']); ?>;"<?php endif; ?>><?php echo htmlentities($v['title']); ?></a>
                                <span class="am-list-date"><?php echo htmlentities($v['add_time']); ?></span>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
    ...
    <div class="am-u-md-2 am-u-md-pull-10 article-sidebar am-padding-0">
        <div class="am-offcanvas" id="article-nav-sidebar">
            <div class="am-offcanvas-bar am-offcanvas-bar-overlay">
                ...
                <?php endif; if(!empty($plugins_view_article_category_left_inside_top_data) and is_array($plugins_view_article_category_left_inside_top_data)): foreach($plugins_view_article_category_left_inside_top_data as $hook): if(is_string($hook) or is_int($hook)): ?>
                            <?php echo $hook; ?>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php endif; ?>
                        ...
                        <div class="am-panel am-panel-default am-panel-group am-margin-bottom-0">
                            ...
                            <ul class="am-nav category-list">
                                <?php foreach($category_list as $v): ?>
                                    <li>
                                        <a href="<?php echo htmlentities($v['url']); ?>" title="<?php echo htmlentities($v['name']); ?>" <?php if(isset($params['id']) and $params['id'] == $v['id']): ?>class="am-active"<?php endif; ?>><?php echo htmlentities($v['name']); ?></a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                ...
                <?php endif; if(!empty($plugins_view_article_category_left_inside_botton_data) and is_array($plugins_view_article_category_left_inside_botton_data)): foreach($plugins_view_article_category_left_inside_botton_data as $hook): if(is_string($hook) or is_int($hook)): ?>
                            <?php echo $hook; ?>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php endif; ?>
