...
<?php endif; if(!empty($plugins_view_article_detail_top_data) and is_array($plugins_view_article_detail_top_data)): foreach($plugins_view_article_detail_top_data as $hook): if(is_string($hook) or is_int($hook)): ?>
            <?php echo $hook; ?>
        <?php endif; ?>
    <?php endforeach; ?>
<?php endif; ?>
	...
	<div class="am-u-md-10 am-u-md-push-2 article-right">
		<div class="article-header am-text-center am-padding-0">
			...
			<p class="am-article-meta">
				<span>发布时间：<?php echo htmlentities($article['add_time']); ?></span>
		...
		<?php endif; if(!empty($plugins_view_article_detail_content_top_data) and is_array($plugins_view_article_detail_content_top_data)): foreach($plugins_view_article_detail_content_top_data as $hook): if(is_string($hook) or is_int($hook)): ?>
                    <?php echo $hook; ?>
                <?php endif; ?>
            <?php endforeach; ?>
        <?php endif; ?>
        ...
        <!-- 文章内容 -->
		<div class="am-article am-scrollable-horizontal"><?php echo $article['content']; ?></div>
        ...
        <div class="last-next-data am-margin-top-lg am-padding-bottom-sm">
            ...
            <div class="am-nbfc am-padding-horizontal-sm">
                <div class="am-nbfc">
                    ...
                    <?php if(!empty($last_next_data['last'])): ?>
                        <a href="<?php echo htmlentities($last_next_data['last']['url']); ?>" class="am-text-primary am-text-truncate am-fl am-block"><?php echo htmlentities($last_next_data['last']['title']); ?></a>
                        <span class="text-tips am-fr"><?php echo htmlentities($last_next_data['last']['add_time']); ?></span>
                    <?php else: ?>
                ...
                <div class="am-nbfc am-margin-top-xs">
                    ...
                    <?php if(!empty($last_next_data['next'])): ?>
                        <a href="<?php echo htmlentities($last_next_data['next']['url']); ?>" class="am-text-primary am-text-truncate am-fl am-block"><?php echo htmlentities($last_next_data['next']['title']); ?></a>
                        <span class="text-tips am-fr"><?php echo htmlentities($last_next_data['next']['add_time']); ?></span>
                    <?php else: ?>
                        <span class="text-tips">没有符合条件的文章</span>
                    <?php endif; ?>
                </div>
		...
		<?php endif; if(!empty($plugins_view_article_detail_content_botton_data) and is_array($plugins_view_article_detail_content_botton_data)): foreach($plugins_view_article_detail_content_botton_data as $hook): if(is_string($hook) or is_int($hook)): ?>
                    <?php echo $hook; ?>
                <?php endif; ?>
            <?php endforeach; ?>
        <?php endif; ?>
						...
						<div class="am-panel am-panel-default am-panel-group am-margin-bottom-0">
							...
							<ul class="am-nav category-list">
								<?php foreach($category_list as $v): ?>
									<li>
										<a href="<?php echo htmlentities($v['url']); ?>" title="<?php echo htmlentities($v['name']); ?>" <?php if(isset($article['article_category_id']) and $article['article_category_id'] == $v['id']): ?>class="am-active"<?php endif; ?>><?php echo htmlentities($v['name']); ?></a>
									</li>
								<?php endforeach; ?>
							</ul>
						</div>
...
<?php endif; if(!empty($plugins_view_article_detail_bottom_data) and is_array($plugins_view_article_detail_bottom_data)): foreach($plugins_view_article_detail_bottom_data as $hook): if(is_string($hook) or is_int($hook)): ?>
            <?php echo $hook; ?>
        <?php endif; ?>
    <?php endforeach; ?>
<?php endif; ?>
